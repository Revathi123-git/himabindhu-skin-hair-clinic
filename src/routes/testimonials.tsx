        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="aspect-video rounded-3xl gradient-hero relative overflow-hidden flex items-center justify-center group cursor-pointer hover-lift"
              >
                ...
                <span className="absolute bottom-4 left-4 text-primary-foreground text-sm">
                  Patient Story #{i}
                </span>
              </div>
            ))}
