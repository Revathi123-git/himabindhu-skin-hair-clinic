...
/* =========================
   ROUTE
   ========================= */
export const Route = createFileRoute("/serv/$slug")({
  loader: ({ params }) => {
...
const FAQS = [
  {
    ...
    a: "Yes — we follow USFDA-approved protocols and use medical-grade equipment. Every session is supervised by Dr. Himabindu.",
  },
  {
    q: "How many sessions are required?",
    a: "Most treatments require 3–6 sessions for visible results, but a personalized plan is created after consultation.",
  },
  {
    q: "Is there any downtime?",
    a: "Most aesthetic treatments have minimal to no downtime. You can resume your routine immediately.",
  },
  {
    q: "Are results permanent?",
    a: "Many results are long-lasting with proper maintenance. We share a clear after-care plan.",
  },
];
        ...
        <div className="container mx-auto px-4 lg:px-8 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mt-6">
            ...
            <div>
              ...
              <Link
                to="/appointment"
                className="mt-7 inline-flex items-center gap-2 px-7 py-4 rounded-full gradient-hero text-primary-foreground font-medium shadow-elegant hover-lift"
              >
                Book Consultation
              </Link>
            </div>
          ...
          <Reveal>
            <div>
              ...
              <p className="mt-3 text-muted-foreground leading-relaxed">
                {service.title} at Dr Himabindu's Clinic combines clinical
                expertise with modern technology. Every treatment plan is
                customized after consultation.
              </p>
            </div>
          </Reveal>
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          <Reveal>
            ...
            <div className="mt-10 grid md:grid-cols-4 gap-6">
              {["Consultation", "Skin Analysis", "Treatment", "Follow-up"].map(
                (step, i) => (
                  <div
                    key={step}
                    className="p-6 rounded-2xl bg-card border text-center"
                  >
                    <div className="w-10 h-10 mx-auto rounded-full gradient-hero text-primary-foreground flex items-center justify-center font-display">
                      {i + 1}
                    </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="rounded-3xl gradient-hero p-10 md:p-14 text-center">
            ...
            <Link
              to="/appointment"
              className="mt-6 inline-block px-8 py-4 rounded-full bg-background text-foreground font-medium shadow-elegant hover-lift"
            >
